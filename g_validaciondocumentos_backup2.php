          	...
          	if ($validado){
          		...
          		$html=' 
					...
					<div style="align:center">
						...
						<p align="justify">Este correo automático ha sido enviado para notificar que la documentación
                        proporcionada para el Concurso de Ensayo 2022 “Retos y perspectivas a 11 años del Presupuesto Participativo en la Ciudad de México”, está incompleta o incorrecta.
                        <br>
                        Aquí las observaciones sobre cada uno de los documentos:</p>';
						...
						$html.='<table>
								...
								<tr style="border-bottom:1px solid #EEE;">
									<td>ensayo</td>
									<td>'.$var_A.'</td>
									<td>'.$observa_ensayo.'<td>
								</tr>
							
								
								<tr style="border-bottom:1px solid #EEE;">
									<td>Manifestación bajo protesta...</td>
									<td>'.$var_D.'</td>
									<td>'.$observa_manifest.'</td>
								</tr>
								<tr style="border-bottom:1px solid #EEE;">
									<td>Carta de cesion de derechos</td>
									<td>'.$var_E.'</td>
									<td>'.$observa_carta.'</td>
								</tr>
							...
							<p>Para corregir los archivos, es necesario ingresar con usuario y contraseña
                            para subir los nuevos archivos,<a href="'.URL_CONCU.'index.php"> haciendo clic aquí</a></p>
