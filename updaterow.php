<?php
 ...
 $index = filter_var($_POST["index"], FILTER_VALIDATE_INT);
    ...
    $query = "SELECT A.*,B.fecha_nacimiento,B.fecha_alta as fecha_alta_usuario FROM ".BD_PARTICIPANTES." as A LEFT JOIN ".BD_USUARIOS." as B ON A.idusuario = B.idusuario WHERE A.idusuario = ?";
...
//////////////////////
   	...
   	if($index==3){
    	...
    	echo '
    			                      <div class="col-sm">';
                                        if($formato){
                                            echo '<a href="uploads/'.$formato_64.'" target="_blank" class="btn btn-primary">Mi formato...</a>';
