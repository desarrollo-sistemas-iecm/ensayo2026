 ...
 * @version 6.3.2
 */
define("__FILE__","libs");
//_FILE_="";

// TCPDF configuration
require_once('libs/tcpdf_autoconfig.php');
// TCPDF static font methods and data
require_once('libs/include/tcpdf_font_data.php');
// TCPDF static font methods and data
require_once('libs/include/tcpdf_fonts.php');
// TCPDF static color methods and data
require_once('libs/include/tcpdf_colors.php');
// TCPDF static image methods and data
require_once('libs/include/tcpdf_images.php');
// TCPDF static methods and data
require_once('libs/include/tcpdf_static.php');
