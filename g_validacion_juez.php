...
<head>
  ...
  <style>
    ...
    .vl-table tbody tr:nth-child(even) { background: #f0f4f8; }
        ...
        <div class="row align-items-center mb-3">
          <div class="col-sm-3">
            <label class="radio-opt">
              <input type="radio" name="radio_busqueda" value="1" checked="checked" onchange="fnRadioBusquedaJuez();">
              Por seudónimo
            </label>
          </div>
          <div class="col-sm-9">
            <div class="search-row">
              <input type="text" class="form-control flex-grow-1" id="select_nombre" name="select_nombre"
                     placeholder="Escribe el sobrenombre o nombre" onchange="fnBusquedaNombreJuez()">
              <button class="btn-buscar" id="btn_nombre" onclick="fnBusquedaNombreJuez()">
       ...
       <div class="row align-items-center mb-3">
        ...
        <div class="row align-items-center">
          <div class="col-12 text-center">
            <button class="btn-todos" id="btn_todos" onclick="fnBusquedaTodosJuez()">
        ...
        <div class="row" style="display:none;">
          <div class="col-sm-3">
            <label class="radio-opt">
              <input type="radio" name="radio_busqueda" value="3" onchange="fnRadioBusquedaJuez();">
              Por distrito
            </label>
          </div>
          <div class="col-sm-9">
